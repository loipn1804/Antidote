...
public class FaqActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<ObjectFaq> listFaq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (activityReceiver != null) {
            ...
            intentFilter.addAction(AntidoteService.RECEIVER_GET_ALL_FAQ);
...
//            intentFilter.addAction(AntidoteService.RECEIVER_ADD_FAQ_COMMENT);
        ...
        Intent intentGetFaq = new Intent(AntidoteService.ACTION_GET_ALL_FAQ, null, FaqActivity.this, AntidoteService.class);
        startService(intentGetFaq);

        listFaq = new ArrayList<ObjectFaq>();
        listIsExpand = new ArrayList<Boolean>();
        listFaqComment = new ArrayList<ObjectFaqComment>();
        faqCommentAdapter = new FaqCommentAdapter(FaqActivity.this, listFaqComment);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rltLeft:
                ...
                break;
            case R.id.rltAddNew:
                if (UserController.isLogin(FaqActivity.this)) {
                    showPopupAddFaq();
                } else {
    ...
    private void showPopupAddFaq() {
        // custom dialog
        dialogAddNew = new Dialog(FaqActivity.this);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                StaticFunction.showKeyboard(FaqActivity.this);
            }
        }, 100);
        ...
        lnlOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ObjectUser user = UserController.getCurrentUser(FaqActivity.this);
                if (user != null) {
                    String question = edtQuestion.getText().toString().trim();
                    if (question.length() == 0) {
                        showToast("Please enter question.");
                    } else {
                        Intent intentAddNew = new Intent(FaqActivity.this, AntidoteService.class);
    ...
    private void showPopupConfirmLogin() {
        // custom dialog
        final Dialog dialog = new Dialog(FaqActivity.this);
        ...
        lnlOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentLogin = new Intent(FaqActivity.this, LoginActivity.class);
    ...
    private void setListFaq() {
        listFaq.clear();
        listIsExpand.size();
        final List<ObjectFaq> list = FaqController.getAllFaqs(FaqActivity.this);
        for (ObjectFaq faq : list) {
            listFaq.add(faq);
        ...
        for (int i = 0; i < listFaq.size(); i++) {
            final ObjectFaq faq = listFaq.get(i);
            final LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View viewRow = inflater.inflate(R.layout.row_faq, null);
...
//                lnlQuestion.setBackgroundColor(getResources().getColor(R.color.blue_home));
                imvExpand.setImageResource(R.drawable.ic_sub_new);
...
//                Intent intentGetFaqComment = new Intent(AntidoteService.ACTION_GET_ALL_FAQ_COMMENT, null, FaqActivity.this, AntidoteService.class);
...
//                lnlQuestion.setBackgroundColor(getResources().getColor(R.color.bg_row_faq));
                imvExpand.setImageResource(R.drawable.ic_plus_new);
...
//                lvContent.setVisibility(View.GONE);
            ...
            lnlShowmore.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intentFaqComment = new Intent(FaqActivity.this, FaqCommentActivity.class);
    ...
    private void notifyDataListFaq(ObjectFaq faq) {
...
//                lvContent.setVisibility(View.GONE);
    ...
    private void setListFaqComment(ListView listView, TextView txtNumComment, Long faqid) {
        ...
        List<ObjectFaqComment> list = FaqCommentController.getFaqCommentsByFaqId(FaqActivity.this, faqid);
    ...
    private BroadcastReceiver activityReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equalsIgnoreCase(AntidoteService.RECEIVER_GET_ALL_FAQ)) {
                ...
                if (result.equals(AntidoteService.RESULT_OK)) {
                    setListFaq();
                    hideProgressDialog();
                    StaticFunction.hideKeyboard(FaqActivity.this);
                    dialogAddNew.dismiss();
                } else if (result.equals(AntidoteService.RESULT_FAIL)) {
                    String message = intent.getStringExtra(AntidoteService.EXTRA_RESULT_MESSAGE);
                    Toast.makeText(getApplicationContext(), message, Toast.LENGTH_LONG).show();
