...
/** 
 * DAO for table OBJECT_COMMENT.
*/
public class ObjectCommentDao extends AbstractDao<ObjectComment, Long> {

    public static final String TABLENAME = "OBJECT_COMMENT";

    /**
     * Properties of entity ObjectComment.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property IdFacebook = new Property(8, String.class, "idFacebook", false, "ID_FACEBOOK");
    };


    public ObjectCommentDao(DaoConfig config) {
        super(config);
    }
    
    public ObjectCommentDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'OBJECT_COMMENT' (" + //
                ...
                "'IMAGE' TEXT," + // 7: image
                "'ID_FACEBOOK' TEXT);"); // 8: idFacebook
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'OBJECT_COMMENT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ObjectComment entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ObjectComment readEntity(Cursor cursor, int offset) {
        ObjectComment entity = new ObjectComment( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8) // idFacebook
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ObjectComment entity, int offset) {
        ...
        entity.setIdFacebook(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ObjectComment entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ObjectComment entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
